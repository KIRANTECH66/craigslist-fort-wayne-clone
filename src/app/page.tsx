      ...
      <section className="mx-auto max-w-6xl px-4 py-6">
        <div className="grid grid-cols-12 gap-6">
          ...
          <aside className="col-span-12 md:col-span-3 order-2 md:order-1">
            <div className="rounded border border-[#cad1d0] bg-white p-4">
              ...
              <div className="grid grid-cols-7 gap-1 text-center text-xs text-[#7c7c7c]">
                ...
                {Array.from({ length: 35 }).map((_, i) => (
                  <a
                    key={i}
                    href="#"
                    className="rounded py-1 hover:bg-[#daecae] hover:text-[#454859]"
                  >
                    {i + 1}
                  </a>
                ))}
            ...
            <div className="mt-6 rounded border border-[#cad1d0] bg-white p-4">
              <ul className="space-y-2 text-sm">
                <li><a className="hover:underline" href="#">help, faq, abuse, legal</a></li>
                <li><a className="hover:underline" href="#">avoid scams & fraud</a></li>
                <li><a className="hover:underline" href="#">personal safety tips</a></li>
                <li><a className="hover:underline" href="#">about craigslist</a></li>
                <li><a className="hover:underline" href="#">best-of-craigslist</a></li>
                <li><a className="hover:underline" href="#">craigslist is hiring</a></li>
                <li><a className="hover:underline" href="#">what's new</a></li>
                <li><a className="hover:underline" href="#">system status</a></li>
              </ul>
            </div>
          </aside>
          ...
          <div className="col-span-12 md:col-span-6 order-1 md:order-2">
            <div className="mb-6 rounded border border-[#cad1d0] bg-white p-4">
              <div className="flex flex-col gap-3 md:flex-row md:items-center">
                <input
                  className="w-full rounded border border-[#cad1d0] bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[#de9edd]"
                  placeholder="search craigslist"
                />
                <button className="mt-2 md:mt-0 rounded bg-[#454859] px-4 py-2 text-sm font-medium text-white hover:bg-black">search</button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-2">
              {[
                ...
                <section key={section.title} className="rounded border border-[#cad1d0] bg-white p-4">
            ...
            <div className="rounded border border-[#cad1d0] bg-white p-4">
              ...
              <ul className="mb-4 columns-2 gap-3 text-sm">
                {["ann arbor","battle creek","bloomington","chicago","cincinnati","columbus","dayton","detroit","flint","grand rapids","holland","indianapolis","jackson","kalamazoo","kokomo","lansing","lima-findlay","mansfield","monroe","muncie","muskegon","richmond","saginaw","sandusky","south bend","southwest mi","terre haute","tippecanoe","toledo"].map((c) => (
                  <li key={c} className="break-inside-avoid py-0.5"><a href="#" className="hover:underline">{c}</a></li>
                ))}
              </ul>
      ...
      <footer className="border-t border-[#cad1d0] bg-white">
        <div className="mx-auto max-w-6xl px-4 py-6 text-sm text-[#7c7c7c]">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <a className="hover:underline" href="#">craigslist charitable</a>
            <a className="hover:underline" href="#">craig newmark philanthropies</a>
